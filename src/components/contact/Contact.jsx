...
const Contact = () => {
  ...
  const sendEmail = (e) => {
    ...
    emailjs.sendForm('service_347yl9o', 'template_5m9dzte', form.current, 'xV8oxY0_Ew8i6-82_')
      .then((result) => {
